...
def viewer(func):
    ...
    function.__doc__ = doc if doc else f"not self.viewer or self.viewer[2]!='{name}':Click to view"
...
class item_functions:
    ...
    @viewer
    def parchment_yellow():
        pass

    @staticmethod
    def letter(game):
        """not self.viewer or self.viewer[2]!='letter':Click to view"""
