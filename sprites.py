...
class DynamicObject(BaseObject, Dynamic):
    def __init__(self, obj):
        ...
        BaseObject.__init__(self)
        Dynamic.__init__(self, obj.x, obj.y, obj.imgs, frame_delta=obj.frame_delta)
...
class MainChar(Dynamic):
    ...
    def draw(self):
        self.game.screen.blit(self.image, self.rect.topleft-self.game.camera)
